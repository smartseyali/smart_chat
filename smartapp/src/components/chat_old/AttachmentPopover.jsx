...
import { colors } from "../../utility/theme.js"; // Adjust the import path as necessary
  ...
  const options = [
    {
      ...
      icon: <PersonIcon sx={{ ...globalIconStyle2 }} />,
    },
    {
      id: "document",
    ...
    },
    {
      ...
      icon: <CameraAltIcon sx={{ ...globalIconStyle2 }} />,
    },
    {
      id: "sticker",
      backgroundColor: colors.blue1,
      icon: <PhotoFilterIcon sx={{ ...globalIconStyle2 }} />,
    },
    {
      id: "gallery",
